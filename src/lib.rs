...
mod js {
    ...
    extern "C" {
        ...
        pub fn getAttribLocation(program: JSObject, name: *const u8, name_length: usize) -> GLuint;
        pub fn linkProgram(program: JSObject);
        pub fn shaderSource(shader: JSObject, source: *const u8, source_length: usize);
...
pub extern "C" fn start() {
    unsafe {
      ...
      void main() {
        ...
        let attrib_location =
            js::getAttribLocation(shader_program, name.as_bytes().as_ptr(), name.len());
